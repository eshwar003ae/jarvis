...
from keyboard_mouse_CTRL import move_cursor_tool, mouse_click_tool, scroll_cursor_tool, type_text_tool, press_key_tool, swipe_gesture_tool, press_hotkey_tool, control_volume_tool,screenshot_tool
...
async def screenshot_tool() -> str:
    """Takes a screenshot of the entire screen and saves it as 'screenshot.png'."""
    try:
        # Save to the current project folder
        path = "screenshot.png"
        pyautogui.screenshot(path)
        return f"✅ Screenshot successfully saved as {path}"
